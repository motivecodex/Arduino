...
//            writeData(0, 0);
     ...
     */
//    public void writeData(int companyname, int firstname, int lastname, int fostudy) {
//        try {
//            output.write(companyname);
//            output.flush();
...
//    }
     ...
     * Did not work correctly
     */
//    public void writeCompanyName(int companyname) {
//        try {
//            output.write(companyname);
//            output.flush();
//        } catch (Exception e) {
...
//        }
//    }
//    public void writeFirstName(int firstname) {
//        try {
//            output.write(firstname);
//            output.flush();
//        } catch (Exception e) {
...
//        }
//    }
//    public void writeLastName(int lastname) {
//        try {
//            output.write(lastname);
//            output.flush();
//        } catch (Exception e) {
...
//        }
//    }
//    public void writeFoStudy(int fostudy) {
//        try {
//            output.write(fostudy);
//            output.flush();
//        } catch (Exception e) {
